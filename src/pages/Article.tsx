    ...
    return (
      <div className="min-h-screen bg-background">
        ...
        <main className="px-5 md:px-20 py-20 text-center">
          <h1 className="heading-lg mb-6">ARTICLE NOT FOUND</h1>
          <Link to="/">
    ...
    <div className="min-h-screen bg-background">
      ...
      <main>
        ...
        <div className="pt-[30px] pb-[30px] sm-590:pt-[60px] sm-590:pb-[60px]">
          <div className="px-5 sm-590:px-10 max-w-[1300px] mx-auto">
            ...
            <div className="text-center clear-both">
              <Link
                to="/"
                className="text-lg sm-590:text-xl text-center no-underline font-bold uppercase tracking-[0.0em] leading-[1.2] inline-block hover:opacity-70 transition-opacity"
              >
                ← BACK TO BLOG
              </Link>
            </div>
        ...
        <section className="border-t border-foreground/10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 p-5 gap-x-5 gap-y-8 md:pt-0 md:px-20 md:pb-8 md:gap-x-16 md:gap-y-8">
